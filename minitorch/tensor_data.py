...
def broadcast_index(
    ...
    #     off = i + (len(big_shape) - len(shape))
    #     if val > 1:
    #         out_index[i] = big_index[off]
    #     else:
    #         out_index[i] = 0
    # return None
...
def shape_broadcast(shape1: UserShape, shape2: UserShape) -> UserShape:
    ...
    #     shape1 = [1 for _ in range(size - len(shape1))] + list(shape1)
    # else:
    #     shape2 = [1 for _ in range(size - len(shape2))] + list(shape2)

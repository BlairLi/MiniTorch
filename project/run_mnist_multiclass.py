...
class Network(minitorch.Module):
    ...
    def __init__(self):
        ...
        # TODO: Implement for Task 4.5.
        self.conv2d1 = Conv2d(1, 4, 3, 3)
        self.conv2d2 = Conv2d(4, 8, 3, 3)
